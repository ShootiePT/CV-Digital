const languageData = {
    'en': {
        ...
        'Coordinated1': 'Lead teams to enhance customer engagement and trust, fostering unique in-store experiences.',
        'Coordinated2': 'Analyze data and business strategies for optimal outcomes and improved performance.',
        'Coordinated3': 'Coordinate cross-functional teams to maximize productivity and efficiency.',
        'Coordinated4': 'Cultivate a culture of innovation and collaboration, driving positive change within the team.',
        'UsedSoftware': 'Used Software:',
        'ContentEditor': 'Content Editor - Mar 2022 - May 2022 <span class="location">Aveiro</span>',
        'Developed1': 'Development of analyses and benchmarks.',
        'Developed2': 'Creation and updating of product technical specifications.',
        'Salesperson': 'Specialized Store Salesperson - Oct 2014 - Mar 2022 <span class="location">Aveiro</span>',
        'Customers1': 'Customer support.',
        'Customers3': 'Inventory control.',
        'Customers4': 'Store stock management.',
        'Customers5': 'Team management.',
        'Customers6': 'IOW (Input-Output Work).',
        'Customers7': 'Sales Force Manager.',
        'WortenSpain': 'WORTEN SPAIN:',
        'Trainer': 'Trainer - Mar 2021 - Apr 2021 <span class="location">Madrid, S. S. Reyes</span>',
        'Manage1': 'Providing ongoing coaching and support to sales team members.',
        'Manage2': 'Implementing mentorship programs to foster professional growth within the sales team.',
        'Manage3': 'Monitoring and evaluating the effectiveness of sales training programs through feedback and performance metrics.',
        'Manage4': 'Store organization.',
        'Blogger': 'Freelance Blogger - Sep 2016 - Feb 2018',
        'GeekLoft':'As a hobby during this period, I created a website called "<a href="https://web.archive.org/web/20231115014304/http://thegeekloft.pt/" target="_blank" class="shop-link beige">TheGeekLoft</a>" to introduce people to the world of video games, including personal experiences from the team. Covered everything from major industry title releases to indie games and startups.',
        'Education': 'EDUCATION',
        ...
        'Polytechnic': 'Polytechnic Institute of Bragança - ESACT - 2010 - 2014 <span class="location">Mirandela</span>',
    ...
    'pt': {
        ...
        'Coordinated1': 'Liderar equipas para aprimorar o envolvimento e a confiança dos clientes, promovendo experiências únicas dentro da loja.',
        'Coordinated2': 'Analisar dados e estratégias de negócio para obter resultados ótimos e melhorar o desempenho.',
        'Coordinated3': 'Coordenar equipas multifuncionais para maximizar a produtividade e eficiência.',
        'Coordinated4': 'Fomentar uma cultura de inovação e colaboração, impulsionando mudanças positivas dentro da equipa.',
        'UsedSoftware': 'Software Utilizado:',
        'ContentEditor': 'Editor de Conteúdos - Mar 2022 - Mai 2022 <span class="location">Aveiro</span>',
        'Developed1': 'Desenvolvimento de análises e benchmarks.',
        'Developed2': 'Criação e atualização de especificações técnicas de produtos.',
        'Salesperson': 'Vendedor Especializado - Out 2014 - Mar 2022 <span class="location">Aveiro</span>',
        'Customers1': 'Apoio ao cliente.',
        'Customers3': 'Controlo de inventário.',
        'Customers4': 'Gestão de stocks em loja.',
        'Customers5': 'Gestão de equipas.',
        'Customers6': 'IOW (Input-Output Work).',
        'Customers7': 'Gestor de Força de Vendas.',
        'WortenSpain': 'WORTEN ESPANHA:',
        'Trainer': 'Formador - Mar 2021 - Abr 2021 <span class="location">Madrid, S. S. Reyes</span>',
        'Manage1': 'Fornecer orientação e apoio contínuos aos membros da equipa de vendas.',
        'Manage2': 'Implementação de programas de mentoria para promover o crescimento profissional dentro da equipa de vendas.',
        'Manage3': 'Monitorização e avaliação da eficácia dos programas de formação em vendas através de feedback e métricas de desempenho.',
        'Manage4': 'Organização da loja.',
        'Blogger': 'Blogger Freelance - Set 2016 - Fev 2018',
        'GeekLoft':'Durante este período, criei o website "<a href="https://web.archive.org/web/20231115014304/http://thegeekloft.pt/" target="_blank" class="shop-link beige">TheGeekLoft</a>" como um hobby para introduzir as pessoas ao mundo dos videojogos, incluindo experiências pessoais. Cobria desde os principais lançamentos da indústria até jogos indie e startups.',
        'Education': 'EDUCAÇÃO',
        ...
        'Polytechnic': 'Instituto Politécnico de Bragança - ESACT - 2010 - 2014 <span class="location">Mirandela</span>',
        ...
        'Trainer2': 'Formador',
        'SSkills': '<strong>Competências</strong>',
